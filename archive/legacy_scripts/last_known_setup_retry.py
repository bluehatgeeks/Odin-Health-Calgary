...
# THE LAST KNOWN WORKING SETUP (from finalize_oauth_and_upload.py and fix_upload.py)
CLIENT_ID = '637011530953-kd3rqqe1d7ootfthtds3iqpioqoreck5.apps.googleusercontent.com'
CLIENT_SECRET = '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'
TOKEN_FILE = '/Users/alexandertretjakov/.copaw/workspaces/default/odin-calgary/.oauth_tokens.json'

def refresh_access_token():
    print(f"Attempting to refresh access token using setup from finalize_oauth_and_upload.py...")
    try:
        ...
        # Update the token file with the new access token
...
def verify_sheets_access():
    try:
        ...
        # Try to list spreadsheets to verify access
